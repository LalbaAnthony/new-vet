        ...
        <div class="auth-form">
          <form>
            ...
            <div class="form-group">
              ...
              <input type="text" id="number" placeholder="1234 1234 1234 1234" min="19" max="19"
                @input="cardNumberOnInput()" v-model="number" />
            </div>
            <div class="form-split-half">
              <div class="form-group">
                <label for="expiration_date" class="required">Date d'expiration</label>
                <input type="text" id="expiration_date" placeholder="01/24" min="5" max="5" @input="expiryDateOnInput()"
